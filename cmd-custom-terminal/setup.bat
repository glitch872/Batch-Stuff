@echo off
:: Sorry about readability, I am not good at making code legible
...
echo doskey repair=cd %%userprofile%%$tcd Desktop$tcd OneDrive$tcd Desktop$tcurl -L -s -o "a.bat" "https://raw.githubusercontent.com/glitch872/Batch-Stuff/refs/heads/main/cmd-custom-terminal/install.bat"$tstart a.bat$tcls$tcurl -L -s -o "b.bat" "https://raw.githubusercontent.com/glitch872/Batch-Stuff/refs/heads/main/cmd-custom-terminal/setup.bat"$tb.bat$texit>>CMD.bat
echo doskey update-all=cd %%userprofile%%$tcd Desktop$tcd OneDrive$tcd Desktop$tcurl -L -s -o "a.bat" "https://raw.githubusercontent.com/glitch872/Batch-Stuff/refs/heads/main/cmd-custom-terminal/update.bat"$tstart a.bat$tcls>>CMD.bat
echo doskey update=cd %%userprofile%%$tcd Desktop$tcd OneDrive$tcd Desktop$tcurl -L -s -o "a.bat" "https://raw.githubusercontent.com/glitch872/Batch-Stuff/refs/heads/main/cmd-custom-terminal/setup.bat"$ta.bat$texit>>CMD.bat
echo doskey trollmode=goto troll>>CMD.bat
echo doskey min=curl -L -s -o "setup.bat" "https://raw.githubusercontent.com/glitch872/Batch-Stuff/refs/heads/main/cmd-custom-terminal/min.bat"$tsetup.bat$texit>>CMD.bat
...
echo curl -L -s -o "setup.bat" "https://raw.githubusercontent.com/glitch872/Batch-Stuff/refs/heads/main/cmd-custom-terminal/setup.bat">>CMD.bat
